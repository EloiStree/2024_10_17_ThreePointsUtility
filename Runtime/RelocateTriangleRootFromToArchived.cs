...
namespace Eloi.ThreePoints
{
    ...
    public class RelocateTriangleRootFromToArchived {
    ...
    public static void MoveToCentroid(Transform whatToMove, I_ThreePointsGet origineTriangle, I_ThreePointsGet toTriangle)
    {
        ...
        ThreePointsUtility.GetCentroid(origineTriangle,out Vector3 from);
        ThreePointsUtility.GetCentroid(toTriangle, out Vector3 to);
